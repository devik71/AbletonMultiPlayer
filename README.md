...
## Що свідомо спрощено у фазі 1

- **Адресація за індексом.** Треки і сцени адресуються індексом, імʼя — контрольна
  сума. Вставка треку посередині розсинхронить адреси; подія тоді відхиляється
  з warning, а не застосовується не туди. Стабільні ID — наступний крок.
